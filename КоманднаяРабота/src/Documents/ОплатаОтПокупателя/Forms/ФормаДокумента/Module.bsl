...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// ++ Гумерова Задача "Вставка реквизита Контактноелицо" 20.08.2025 
	Если Элементы.Найти("КонтактноеЛицо") = Неопределено Тогда
		...
		ОбКонтактноеЛицо = Элементы.Вставить("КонтактноеЛицо", Тип ("ПолеФормы"), , Элементы.Основание );
		ОбКонтактноеЛицо.Вид = ВидПоляФормы.ПолеВвода;
		ОбКонтактноеЛицо.ПутьКДанным = "Объект.ДЗ_КонтакноеЛицо";
	КонецЕсли;
	// -- Гумерова Задача ___ 20.08.2025 
